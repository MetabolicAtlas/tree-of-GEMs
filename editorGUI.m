...
%% Add model
addModel = uipanel(fig,...
    'Position',[.25 0 0.75 1],...
    'Visible','off');

text_addPMID = uicontrol(addModel,'Style','text',...
    'String','Article PMID',...
    'Position',[10 370 120 30],...
    'HandleVisibility','off');
addpmid = uicontrol(addModel,'Style','edit',...
    'Position',[10 350 120 30],...
    'HandleVisibility','off');

text_addDOI = uicontrol(addModel,'Style','text',...
    'String','DOI',...
    'Position',[10 310 120 30],...
    'HandleVisibility','off');
addDOI = uicontrol(addModel,'Style','edit',...
    'Position',[10 290 200 30],...
    'HandleVisibility','off');

text_addArticleTitle = uicontrol(addModel,'Style','text',...
    'String','Article Title',...
    'Position',[10 210 120 30],...
    'HandleVisibility','off');

addArticleTitle = uicontrol(addModel,'Style','edit',...
    'Position',[10 200 400 20],...
    'HandleVisibility','off');


text_addTaxCommon = uicontrol(addModel,'Style','text',...
    'String','Common Name',...
    'Position',[10 160 120 30],...
    'HandleVisibility','off');

addTaxCommon = uicontrol(addModel,'Style','edit',...
    'Position',[10 150 400 20],...
    'HandleVisibility','off');

text_addTaxSci = uicontrol(addModel,'Style','text',...
    'String','Scientific Name',...
    'Position',[10 110 120 30],...
    'HandleVisibility','off');

addTaxSci = uicontrol(addModel,'Style','edit',...
    'Position',[10 100 400 20],...
    'HandleVisibility','off');

text_addTaxID = uicontrol(addModel,'Style','text',...
    'String','Taxon ID (Pubmed)',...
    'Position',[10 60 120 30],...
    'HandleVisibility','off');

addTaxID = uicontrol(addModel,'Style','edit',...
    'Position',[10 30 400 40],...
    'HandleVisibility','off');


button_addModel = uicontrol(addModel,'Style','pushbutton',...
    'String','Add model',...
    'Position',[200 350 120 30],...
    'HandleVisibility','off',...
    'Callback',@addNewModel);
%% Connection
p = uipanel(fig,...
    'Position',[.25 0 0.75 1],...
    'Visible','on');

text_NrOfConnections = uicontrol(p,'Style','text',...
    'Position',[250 250 160 100],...
    'HandleVisibility','off');
...
%% Callbacks
    function bselection(source,event) %Switch display based on sidebar
        ...
        addModel.Visible = 'off';
        if strcmp(bg.SelectedObject.String,'Connection')==1
            p.Visible = 'on';
            MLnr=str2double(currentChildMLnr.String);
            text_NrOfConnections.String = strjoin([...
                'Current number of parents:' string(length(dataset(MLnr).connection))]);
        ...
        elseif strcmp(bg.SelectedObject.String,'Add model')==1
            addModel.Visible = 'on';
        end
    end
    ...
    function addNewModel(source,event)
        newPos = 1 +length(dataset);
        dataset(newPos).title = addArticleTitle.String;
        dataset(newPos).articleInformation = [];
        dataset(newPos).articleInformation.PMID = addpmid.String;
        dataset(newPos).articleInformation.DOI = addDOI.String;
        dataset(newPos).articleInformation.taxName = addTaxCommon.String;
        dataset(newPos).articleInformation.taxSciName = addTaxSci.String;
        dataset(newPos).articleInformation.taxID = addTaxID.String;
        %clear
